            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex space-x-6 w-full">
                        <!-- Total Books -->
                        <div class="bg-blue-100 w-full p-6 rounded shadow text-center">
                        ...
                        <!-- Total Categories -->
                        <div class="bg-green-100 w-full p-6 rounded shadow text-center">
                        ...
                        <!-- Total Loans -->
                        <div class="bg-yellow-100 w-full p-6 rounded shadow text-center">

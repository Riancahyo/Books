                        ...
                        <table class="min-w-full border border-gray-300 text-sm text-gray-700">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="px-3 py-2 border text-center">Nama</th>
                            ...
                            <tbody>
                                @forelse ($categories as $category)
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-3 py-2 border text-center">{{ $category->id }}</td>
                                        <td class="px-3 py-2 border text-center font-medium">{{ $category->name }}</td>
                                        <td class="px-3 py-2 border">{{ $category->description ?? '-' }}</td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-3 py-2 border text-center">Tidak ada data kategori.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
